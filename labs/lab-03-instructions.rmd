...
**The following provides examples of functions to use as you create your visualization.**
**You will have to modify the arguments in each function to replicate the NYT graphic appropriately.**
...
#### 8. Continue to use plotting functions and arguments in this week's readings and other resources to make your visualization as similar to the NYT graphic as possible.
